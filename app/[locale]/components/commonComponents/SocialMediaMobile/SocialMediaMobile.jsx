...
const Facebook = () => {
    return <Link href="https://www.facebook.com/ENGforUARMY" target="_blank" rel="noopener noreferrer" className={styles.socialBtn}> 
        <svg className={styles.svgIcon} width="70" height="50" viewBox="0 0 70 52" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M71 51V1H1V35.8126L16.6742 51H71Z" stroke="#231F20" stroke-linecap="square"/>
            <defs>
...
const Youtube =()=>  {
    return <Link href="https://www.youtube.com/@engforuarmy/" target="_blank" rel="noopener noreferrer" className={styles.socialBtn}>
...
const Instagram =()=> {
    return <Link href="https://www.instagram.com/engforuarmy/" target="_blank" rel="noopener noreferrer" className={styles.socialBtn}>     
        <svg className={styles.svgIcon} width="70" height="50" viewBox="0 0 72 52" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M71 51V1H1V35.8126L16.6742 51H71Z" stroke="#231F20" stroke-linecap="square"/>
...
const Telegram = () => {
    return <Link href="https://t.me/ENGforUARMY" target="_blank" rel="noopener noreferrer" className={styles.socialBtn}>
        <svg className={styles.svgIcon} width="70" height="50" viewBox="0 0 72 52" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M71 51V1H1V35.8126L16.6742 51H71Z" stroke="#231F20" stroke-linecap="square"/>
