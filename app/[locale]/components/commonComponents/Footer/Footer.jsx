    ...
    <footer className={styles.footer}>
      <div className={styles.footer__container}>
          ...
          <nav>
              <ul className={styles.menu__list}>
                <li className={styles.menu__item}>
                  <Link className={styles.menu__link} href={`/${locale}`} onClick={(e) => e.currentTarget.blur()}>{t("homepage")}</Link>
                </li>

                <li className={styles.menu__item}>
                  <Link className={styles.menu__link} href={`/${locale}#ourProjects`} onClick={(e) => e.currentTarget.blur()}>{t("study")}</Link>
                </li>

                <li className={styles.menu__item}>
                  <Link className={styles.menu__link} href={`/${locale}/team`} onClick={(e) => e.currentTarget.blur()}>{t("ourTeam")}</Link>
                </li>

                <li className={styles.menu__item} >
                  <Link className={styles.menu__link} href={`/${locale}/contact`} onClick={(e) => e.currentTarget.blur()}>{t("contactUs")}</Link>
                </li>
              </ul>
          </nav>
        </div>
          ...
          <div className={styles.contacts}>
            ...
            <ul>
              <li className={styles.contacts__item}>
                <a className={styles.contacts__link} onClick={(e) => e.currentTarget.blur()} href="tel:+380738937097">
              ...
              <li className={styles.contacts__item}>
                <a className={styles.contacts__link} onClick={(e) => e.currentTarget.blur()} href="mailto:engforuarmy@gmail.com">
          ...
          <div className={styles.social}>
            ...
            <ul className={styles.social__list}>
              <li className={styles.social__item}>
                <Link className={styles.social__link} href="https://www.facebook.com/ENGforUARMY" target="_blank" rel="noopener noreferrer" aria-label="Open facebook page of Eng for uarmy" onClick={(e) => e.currentTarget.blur()}>
              ...
              <li className={styles.social__item}>
                <Link className={styles.social__link} href="https://www.instagram.com/engforuarmy/" target="_blank" rel="noopener noreferrer" aria-label="Open instagram page of Eng for uarmy" onClick={(e) => e.currentTarget.blur()}>
              ...
              <li className={styles.social__item}>
                <Link className={styles.social__link} href="https://t.me/ENGforUARMY" target="_blank" rel="noopener noreferrer" aria-label="Open telegram channel of Eng for uarmy" onClick={(e) => e.currentTarget.blur()}>
                  <svg className={styles.social__icon} width="15" height="16" viewBox="0 0 15 16">
              ...
              <li className={styles.social__item}>
                <Link className={styles.social__link} href="https://www.youtube.com/@engforuarmy/" target="_blank" rel="noopener noreferrer" aria-label="Open youtube channel of Eng for uarmy" onClick={(e) => e.currentTarget.blur()}>
                  <svg className={styles.social__icon} width="15" height="16" viewBox="0 0 15 16">
        ...
        <div className={styles.policy}>
            <p className={styles.policy__link}>{t("policy-first")} &copy; {t("policy-second")}</p>
          <div className={styles.policy__list}>
            <span className={styles.policy__divider}></span>
            <Link href="https://drive.google.com/file/d/1Rbz3zkqlXLNpHudyo3fqCwRMsEOdg21R/view" target="_blank" rel="noopener noreferrer" aria-label="Open conditions of use of Eng for uarmy" className={styles.policy__link}>{t("statute")}</Link>
             <span className={styles.policy__divider}></span>
