...
const ContactsForm = () => {
    const [formData, setFormData] = useState({ email: "", number: "", facebookURL: "", instagramURL: "", telegramURL: "", youtubeURL: "" });
    ...
    return <form onSubmit={handleSubmit} autoComplete="off">
        <div className={styles.contactWrapper}>
            <ContactInput value={values.number} name="number" type="text" label="Номер телефону" onChange={handleChange} onBlur={handleBlur}
                icon={<svg
                    width="22"
                    height="22"
                    viewBox="0 0 15 16"
            ...
            <ContactInput value={values.email} name="email" type="email" label="Електронна адреса" onChange={handleChange} onBlur={handleBlur}
                icon={<svg
                    width="22"
                    height="15"
                    viewBox="0 0 15 11"
        ...
        <div className={styles.socialWrapper}>
            <ContactInput value={values.facebookURL} name="facebookURL" type="text" onChange={handleChange} onBlur={handleBlur}
                icon={<svg
            ...
            <ContactInput value={values.instagramURL} name="instagramURL" type="text" onChange={handleChange} onBlur={handleBlur}
                icon={<svg
            ...
            <ContactInput value={values.telegramURL} name="telegramURL" type="text" onChange={handleChange} onBlur={handleBlur}
                icon={<svg
                    className={styles.social__icon}
                    width="20"
                    height="20"
            ...
            <ContactInput value={values.youtubeURL} name="youtubeURL" type="text" onChange={handleChange} onBlur={handleBlur}
                icon={<svg
                    className={styles.social__icon}
                    width="20"
                    height="20"
