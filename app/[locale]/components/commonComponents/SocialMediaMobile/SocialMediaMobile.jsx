...
}} href="https://www.facebook.com/ENGforUARMY" target="_blank" rel="noopener noreferrer" className={styles.socialItem} aria-label="Open facebook page of Eng for uarmy"> 
        <svg className={styles.svgIcon} width="70" height="50" viewBox="0 0 70 52" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip0_826_7826)">
...
const Instagram =()=> {
    return <Link onClick = {(e) => {
    e.currentTarget.blur()
}} href="https://www.instagram.com/engforuarmy/" target="_blank" rel="noopener noreferrer" className={styles.socialItem} aria-label="Open instagram page of Eng for uarmy">     
        <svg className={styles.svgIcon} width="70" height="50" viewBox="0 0 72 52" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip0_826_7816)">
...
const Telegram = () => {
    return <Link onClick = {(e) => {
    e.currentTarget.blur()
}} href="https://t.me/ENGforUARMY" target="_blank" rel="noopener noreferrer" className={styles.socialItem} aria-label="Open telegram channel of Eng for uarmy">
        <svg className={styles.svgIcon} width="70" height="50" viewBox="0 0 72 52" fill="none" xmlns="http://www.w3.org/2000/svg">
