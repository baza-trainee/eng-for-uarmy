          ...
          <div className={styles.contacts}>
            ...
            <ul>
              <li className={styles.contacts__item}>
                <a className={styles.contacts__link} href="tel:+380738937097">
              ...
              <li className={styles.contacts__item}>
                <a className={styles.contacts__link} href="mailto:engforuarmy@gmail.com">
          ...
          <div className={styles.social}>
            ...
            <ul className={styles.social__list}>
              <li className={styles.social__item}>
                <Link className={styles.social__link} href="https://www.facebook.com/ENGforUARMY" target="_blank" rel="noopener noreferrer" aria-label="Open facebook page of Eng for uarmy">
              ...
              <li className={styles.social__item}>
                <Link className={styles.social__link} href="https://www.instagram.com/engforuarmy/" target="_blank" rel="noopener noreferrer" aria-label="Open instagram page of Eng for uarmy">
              ...
              <li className={styles.social__item}>
                <Link className={styles.social__link} href="https://t.me/ENGforUARMY" target="_blank" rel="noopener noreferrer" aria-label="Open telegram channel of Eng for uarmy">
                  <svg className={styles.social__icon} width="15" height="16" viewBox="0 0 15 16">
              ...
              <li className={styles.social__item}>
                <Link className={styles.social__link} href="https://www.youtube.com/@engforuarmy/" target="_blank" rel="noopener noreferrer" aria-label="Open youtube channel of Eng for uarmy">
                  <svg className={styles.social__icon} width="15" height="16" viewBox="0 0 15 16">
